...
2. 로비 화면에 네이버, 카카오 api가져와서 회원가입 기능 추가

3. 알림 기능 구현해서 사용자 API에 푸시 알림 보내는 기능 추가

4. SNS로 회원가입 직후 Lobby로 가기 전 회원정보 입력 받는 화면 추가(각종 정보 등록 ,고유 uid 임의로 database 저장 기능 필수)

5. 프로필 프레그먼트 사용자 설정 -> 내 정보 변경  구상 ( 비밀번호(SNS 로그인은 불가), 전화번호, 닉네임 변경 기능 구현) )
