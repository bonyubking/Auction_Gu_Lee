...
2. 로비 화면에 카카오, 네이버, 구글 api가져와서 회원가입하는 기능 추가

3. 프로필 프레그먼트 알림 기능 구현하기 - (키워드 설정(on/off 기능 X), 채팅 알림, 거래 알림(Chip 사용)) 

4. 프로필 프레그먼트 키워드 알림/채팅,  언어 설정, 캐시 데이터 삭제하기란은 삭제

5. 프로필 프레그먼트 사용자 설정 구상 ( 비밀번호(APi로그인은 불가) , 전화번호, 닉네임 변경 기능 구현) )

6. 프로필 프레그먼트 (광고는 나중에 보류)
